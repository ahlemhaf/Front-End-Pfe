...
import ClientAPI from 'src/views/services/ClientService'
...
function UpdateClient() {
  ...
  useEffect(()=>{
    const fetchdata=async()=>{
      const data=await ClientAPI.getClienteById(params.id)
      setList(data.data)
  ...
  const handleSubmit = async () => {
    try {
       const user=await ClientAPI.UpdateClientById(list , params.id)
       console.log(user);
  ...
  return (
    ...
    {/* <div className="form-group">
        <label > Genre: </label>
        <input type="text" onChange={handleChange} value={list.genre} className="form-control" id="genre" />
    </div> */}
    <div className="form-group">
        <label > Email: </label>
    ...
    <div className="form-group">
        <label > Role: </label>
        <input type="text" onChange={handleChange} value={list.role} className="form-control" id="role" />
    </div>
