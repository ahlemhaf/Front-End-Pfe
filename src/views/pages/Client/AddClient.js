...
import clientAPIS from 'src/views/services/ClientService'
...
function AddClient() {
  ...
  return (
    ...
    {/* <div className="form-group">
        <label > Genre: </label>
        <select type="text" onChange={handleChange} className="form-control" id="genre" >
    ...
    <div className="form-group">
        <label > Role: </label>
        <input type="text" onChange={handleChange} className="form-control" id="role" />
    </div>
